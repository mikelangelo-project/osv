...
$(out)/drivers/virtio-rdmacm.o: INCLUDES += -isystem bsd/sys/ofed/include
$(out)/drivers/virtio-rdmacm.o: INCLUDES += -isystem bsd/sys/ofed/drivers/hw
$(out)/drivers/virtio-rdmacm.o: INCLUDES += -isystem modules/vrdma-ulibs/libibverbs/include
...
drivers += drivers/virtio-rdmacm.o
