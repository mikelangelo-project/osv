...
#define RDMACM_MAX_PRIVATE_DATA 256
    ...
    struct vrdmacm_resolve_addr_copy_args {
        struct hcall_header hdr;
        __u32 ctx_handle;
        __s32 timeout_ms;
        __u32 src_available;
    ...
    struct vrdmacm_resolve_addr_result {
        struct hcall_ret_header hdr;
        __s32 value;
    };

    struct vrdmacm_init_qp_attr_copy_args {
        struct hcall_header hdr;
        __u32 ctx_handle;
    };

    struct vrdmacm_init_qp_attr_result {
        struct hcall_ret_header hdr;
        __s32 value;
    };
    ...
    struct vrdmacm_destroy_id_copy_args {
        struct hcall_header hdr;
        __u32 ctx_handle;
    };

    struct vrdmacm_destroy_id_result {
        struct hcall_ret_header hdr;
        __s32 value;
    };
