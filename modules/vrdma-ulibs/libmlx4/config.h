...
/* Define to 1 if more_ops is a member of ibv_context */
/* #undef HAVE_IBV_MORE_OPS */

/* Define to 1 if you have the `ibv_register_driver' function. */
#define HAVE_IBV_REGISTER_DRIVER 1

/* Define to 1 if have xrc ops */
...
/* Name of package */
#define PACKAGE "libmlx4"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "general@lists.openfabrics.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "libmlx4"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libmlx4 1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "libmlx4"
