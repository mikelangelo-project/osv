...
usr_files.link(os.path.join(_module, '/usr/lib/libibverbs.so.1')).to('/usr/lib/libibverbs.so.1.0.0')
usr_files.link(os.path.join(_module, '/usr/lib/libibverbs.so')).to('/usr/lib/libibverbs.so.1.0.0')
